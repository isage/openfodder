...
*This is unofficial Vita port, please don't ask for support by the links below*
...
1. Install VPK
2. Copy contents of [Data pack](https://github.com/OpenFodder/data/releases/download/1.6.0/Data.pack.1.6.0.zip) to `ux0:/data/OpenFodder`
3. Please see [INSTALL.md](https://github.com/OpenFodder/openfodder/blob/master/INSTALL.md#retail-data) for retail data installation
